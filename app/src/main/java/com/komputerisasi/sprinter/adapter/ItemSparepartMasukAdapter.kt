...
import com.komputerisasi.sprinter.model.DataItemSparepartMasuk
import kotlinx.android.synthetic.main.item_data_item_sparepart.view.*
import org.jetbrains.anko.sdk27.coroutines.onClick

class ItemSparepartMasukAdapter(val data: List<DataItemSparepartMasuk>?, private val click: onClickItem) : RecyclerView.Adapter<ItemSparepartMasukAdapter.MyHolder>() {
    ...
    class MyHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun onBind(get: DataItemSparepartMasuk?) {
    ...
    interface onClickItem{
        fun clicked (item: DataItemSparepartMasuk?)
        fun delete(item: DataItemSparepartMasuk?)
