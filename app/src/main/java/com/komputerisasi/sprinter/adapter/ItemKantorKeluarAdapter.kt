...
import com.komputerisasi.sprinter.model.DataItemKantorKeluar
import kotlinx.android.synthetic.main.item_data_item_kantor.view.*
import org.jetbrains.anko.sdk27.coroutines.onClick

class ItemKantorKeluarAdapter(val data: List<DataItemKantorKeluar>?, private val click: onClickItem) : RecyclerView.Adapter<ItemKantorKeluarAdapter.MyHolder>() {
    ...
    class MyHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun onBind(get: DataItemKantorKeluar?) {
    ...
    interface onClickItem{
        fun clicked (item: DataItemKantorKeluar?)
        fun delete(item: DataItemKantorKeluar?)
