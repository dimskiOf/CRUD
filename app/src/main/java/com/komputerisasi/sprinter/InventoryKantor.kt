...
import com.komputerisasi.sprinter.DataManagement.CheckStokFG
import com.komputerisasi.sprinter.DataManagement.CheckStokItemKantor
import com.komputerisasi.sprinter.DataManagement.ItemKantorKeluar
import com.komputerisasi.sprinter.DataManagement.ItemKantorMasuk
...
import kotlinx.android.synthetic.main.activity_inventory_kantor.*
import org.jetbrains.anko.startActivity
import java.io.IOException


class InventoryKantor : AppCompatActivity(),CrudView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkstokitem.setOnClickListener {
            try {
                presenter.Pingapi(applicationContext, "rezdnov123")
            }catch(e: IOException){
                Toast.makeText(applicationContext, e.message, Toast.LENGTH_SHORT).show()
        ...
        itemmasuk.setOnClickListener {
            try {
                presenter.Pingapi(applicationContext, "rezdnov123")
            }catch(e: IOException){
                Toast.makeText(applicationContext, e.message, Toast.LENGTH_SHORT).show()
            }
            startActivity<ItemKantorMasuk>()
            finish()
        }
