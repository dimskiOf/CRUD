...
import com.komputerisasi.sprinter.DataManagement.HasilScannFG
...
class ScannCheckStokFG : AppCompatActivity(), CrudView {
    ...
    override fun onSuccessGetScanChekStok(data: List<ChekStokItem>?) {
        ...
        data?.forEach{
                i ->
            val b = Intent(this, HasilScannFG::class.java)
